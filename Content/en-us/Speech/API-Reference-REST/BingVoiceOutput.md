...
Note! Until you have submitted your subscription key as described in [Bing Voice Recognition, 2. Voice Recognition Request: Authenticate the API call](./BingVoiceRecognition.md).
