...
You may download the Speech API client library and example through  [SDK](../../SDK-Sample?api=bing%20speech). The downloaded zip file needs to be extracted to a folder of your choice, many users choose the Visual Studio 2015 folder.
